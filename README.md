...
crates/tracker-github   # 公式 GitHub Tracker プラグイン (gh CLI)
```
...
- `wsm-tracker-github-aarch64-apple-darwin` → `~/.local/bin/wsm-tracker-github` (ホストのみ。config.toml の `[[tracker]]` で登録)
